...
> These are multidimensional arrays, with the vector or lengths of each dimension given as a vector for the second argument.
> 1:5 doesn't technically have dimensions and is not an array, it is a vector.
