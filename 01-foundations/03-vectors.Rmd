...
> Logical vectors take precedence over all ather types. All other vector types can be coerced to logical/from binarys


5. Precisely what do is.atomic(), is.numeric(), and is.vector() test for?
 
> is.atomic - tests whether an object is atomic (may not be a vector), is.numeric - tests for modes and implicit classes, not type, and 
